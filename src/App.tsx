...
function Header()
{
    return (
        <>
            <br /><br /><br />
            <h2>This is a website for listing information about all the colleges in NCAA Basketball.</h2>
            <br /><br /><br />
            <br /><br /><br />
        </>
    )
...
function CardList() {
    return (
        <>
            ...
            {teams.teams.map((team: {school: string; name: string; city: string; state: string}) => {
                return (

                    <TeamCard school={team.school} name = {team.name} city={team.city} state={team.state} />
                )})}
